...
class UeMetrics final :
 ...
 public:
  ...
  bool has_ul_harq_ack() const;
  private:
  bool _internal_has_ul_harq_ack() const;
  public:
  void clear_ul_harq_ack();
  bool ul_harq_ack() const;
  void set_ul_harq_ack(bool value);
  private:
  bool _internal_ul_harq_ack() const;
  void _internal_set_ul_harq_ack(bool value);
  public:
...
// optional bool ul_harq_ack = 20;
inline bool UeMetrics::_internal_has_ul_harq_ack() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool UeMetrics::has_ul_harq_ack() const {
  return _internal_has_ul_harq_ack();
}
inline void UeMetrics::clear_ul_harq_ack() {
  _impl_.ul_harq_ack_ = false;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline bool UeMetrics::_internal_ul_harq_ack() const {
  return _impl_.ul_harq_ack_;
}
inline bool UeMetrics::ul_harq_ack() const {
  // @@protoc_insertion_point(field_get:UeMetrics.ul_harq_ack)
  return _internal_ul_harq_ack();
}
inline void UeMetrics::_internal_set_ul_harq_ack(bool value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.ul_harq_ack_ = value;
}
inline void UeMetrics::set_ul_harq_ack(bool value) {
  _internal_set_ul_harq_ack(value);
